...
***** TODO New keyboards, Token
:LOGBOOK:
- State "TODO"       from              [2026-02-19 Thu 20:46]
:END:

See lookup_keyboard, there's some new stuff like ~dual~.
~pub enum Token~ there's this new(?) double-dot equals: ~..=~
  
***** TODO New integer type syntax
:LOGBOOK:
CLOCK: [2026-02-20 Fri 19:41]--[2026-02-20 Fri 20:44] =>  1:03
- - Cleanup tests, add CST test, sanity check all of that.
CLOCK: [2026-02-19 Thu 20:35]--[2026-02-19 Thu 21:50] =>  1:15
- - Found IntegerTypeSuffix, attempted first integration.
  - Still a bug surrounding test case for integer literals, will need to continue
    looking at that when resuming.
- State "TODO"       from              [2026-02-19 Thu 20:35] \\
  Determine changes and implement
CLOCK: [2026-02-19 Thu 20:13]--[2026-02-19 Thu 20:32] =>  0:19
- Determining where error was coming from in cmp.nr after upgrade.
:END:

Upgrade error at locus: noir/noir_stdlib/src/cmp.nr     559,0 - 596,1

New syntax allows you to specify integer type with trailing underscore.
#+begin_example
// Call 'some_function' with integer 20 which is specified as a u64.
some_function(20_u64);
#+end_example
...
[[https://github.com/tree-sitter/tree-sitter/pull/4284][#4284]] fix(make): make install shouldn’t fail when a parser bundles no queries
