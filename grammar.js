...
module.exports = grammar({
    ...
    rules: {
        ...
        // [[file:noir_grammar.org<2>::statement]]
        _statement_ast: $ => seq(
            // TODO: Attributes.
            $._statement_kind,
            ';',
        ...
        // [[file:noir_grammar.org<2>::statement_kind]]
        _statement_kind: $ => choice(
            $.break_statement,
        ),
        // [[file:noir_grammar.org<2>::break_statement]]
        ...
        // [[file:noir_grammar.org<2>::slice_expression]]
