...
***** TODO Implementation                                      :node:cluster:
:PROPERTIES:
...
=impl= eaten before parse_impl called, within parse_impl: parse_generics, parse_type_or_error then eat =for= (kw). If eaten try and parse TraitImpl, otherwise TypeImpl.
...
:pgd:
+ =impl= (kw)
+ [[#h:BA1422E4-AB97-4099-8346-5845CA9223A1][Generics]]
+ [[#h:B3490B7C-F387-49C7-BF94-DC9CE8AC3581][Type]]
+ [[#h:4E657C7B-45FD-45D0-84B2-DB55C1D09192][TypeImplBody]]
:end:

******* TODO TypeImplBody                                              :node:
:PROPERTIES:
