...
seq(
    ...
    'trait',
    field('name', <<r("identifier")>>),
    field('type_parameters', optional(<<r("generics")>>)),
...
#+name: generics
#+begin_src js :rule type_parameters :arg $ :ast Generics
seq(
    '<',
    sepBy(<<r("generic")>>, ','), // Inlined Noirc: GenericsList.
    optional(','),
    '>',
)
#+end_src
...
#+name: generic
#+begin_src js :rule _generic :arg $ :ast Generic
choice(
...
*** [[file:noir/compiler/noirc_frontend/src/parser/parser/path.rs::fn parse_path_impl(][Parser::parse_path_impl(allow_turbofish, allow_trailing_double_colon)]]
:PROPERTIES:
...
<<c('("path" "path_no_turbofish" "identifier_or_path_no_turbofish" "path_identifiers"))>>
<<n("path_kind")>>
<<n("identifier")>>
#+end_src
