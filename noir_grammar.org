...
****** TOIMPL AddOrSubtractTypeExpression
:PROPERTIES:
...
******* TOIMPL MultiplyOrDivideOrModuloTypeExpression
:PROPERTIES:
...
********** TOIMPL ParenthesizedTypeExpression
:PROPERTIES:
...
#+begin_src js :comments noweb :treesit
...
**** ItemVisibility
#+transclude: [[#h:46B8EF89-89A5-4346-9B5B-04630DAEF262][ItemVisibility]] :treesit
...
#                          ("TOIMPL" . org-warning)
# ("BLOCK" . org-verbatim))
# org-babel-header-args:js: '((treesit . :any))
# End:
