...
- [[#h:FF901AEF-D40D-44AB-9BA6-C324F3531088][Attributes]] by [[#h:2A9D09A5-2E52-4B8C-ABA1-0B3B953F093C][Modifiers]] by:
...
- [[#h:98FC5657-8034-42F7-A263-3172EFEEEB23][ComptimeType]].
- [[#h:87984AE0-613D-4D9A-A64D-D3FD8BD51C98][ResolvedType]].
- [[#h:21789349-305A-46D0-8D87-D7B8647482CF][InternedType]].
:end:
...
:END:
:pgd:
- [[#h:9653A5E5-2857-4FB4-8698-5D9F6F0E8755][Unit]].
- [[#h:CF9505CB-8110-4FC2-8A6B-5D88A7EB1D06][TupleElement]].
:end:
...
#+begin_src js :treesit
unit_type: _ => seq('(', ')')
#+end_src

Parser: /in slice of parent/.

******* TODO TupleElement                                              :node:
:PROPERTIES:
...
#+transclude: [[file:noir/compiler/noirc_frontend/src/parser/parser/statement.rs][Statement doc]] :lines 25-25 :src rust
...
,#+transclude: [[#h:30A04BE4-E1C5-40E1-B2B2-DA0747C66D48][Definition / Modifiers]] :treesit
...
#+transclude: [[#h:9653A5E5-2857-4FB4-8698-5D9F6F0E8755][Unit]] :treesit
