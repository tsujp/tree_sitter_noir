...
block_comment: ($) => seq(
    '/*',
    // choice(
    //     // Three asterisks is still a normal block comment, not an outer-style.
    //     seq(token.immediate(prec(2, '**')), $._block_comment_content),
    //     prec(2, seq(
    //         field('style', $.__block_comment_doc_style),
    //         // optional(field('content', alias($._block_comment_content, $.doc_comment))),
    //         field('content', alias($._block_comment_content, $.doc_comment)),
    //     )),
